...
class WallCover(name: String = "", description: String = "", price: Int = 0) : BaseModel() {
    ...
    override fun getTypeName() = "wallcover"
    ...
    fun loadModel(json: JsonObject, imageInput: InputStream?): WallCover {
        updateModel(json)
